...
//        boolean targetFloorTileOnFire = activeEffects.get(targetFloorTilePosition).getEffectType() == java.EffectType.FIRE;
    ...
    public void insert(int colNum, int rowNum, FloorTile tile, int rotation)
        ...
        FloorTile pushedOffTile; // java.Tile being pushed off
    ...
    /**
     * Gets a java.Player index by given java.Player Piece Image.
