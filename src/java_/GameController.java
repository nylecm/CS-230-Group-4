...
public class GameController implements Initializable {
     ...
     */
    private final String ERROR_SOUND = "src/resources/error.mp3";

    /**
     * Is set to the corners of the Game Board View to solve
     * any centering issues.
     */
    private final Image CORNER_PLACEHOLDER = new Image("/resources/cornerPlaceholder.png");

    /**
     * The image for edge tiles for insertion.
     */
    private final Image EDGE_TILE = new Image("/resources/edgeTile.png");
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            backgroundFill = new BackgroundFill(new ImagePattern(new Image(String.valueOf(new File("src/resources/oberon_from_discord.png").toURI().toURL()))), CornerRadii.EMPTY, Insets.EMPTY);
...
//            playerPiecesAtFloorTile.get(i).setLayoutY(targetRow * TILE_HEIGHT + 12);
    ...
    private String getFloorTileTypeImage(FloorTile floorTile) {
        ...
        switch (type) {
            case STRAIGHT:
                return "resources/straightFlat.png";
            case CORNER:
                return "resources/cornerFlat.png";
            case T_SHAPED:
                return "resources/t-shapedFlat.png";
            case GOAL:
                return "resources/goalFlat.png";
        }
        return null;
    }
    ...
    private String getActionTileTypeImage(ActionTile actionTile) {
        ...
        switch (type) {
            case FIRE:
                return "resources/FireActionTile.png";
            case ICE:
                return "resources/IceActionTile.png";
            case BACKTRACK:
                return "resources/backTrackActionTile.png";
            case DOUBLE_MOVE:
                return "resources/doubleMoveActionTile.png";
        }
        return null;
    }
    ...
    private String getEffectTypeImage(EffectType type) {
        switch (type) {
            case FIRE:
                return "resources/fireOverlay.png";
            case ICE:
                return "resources/iceOverlay.png";
        }
        return null;
    }
    ...
    private void animateBackground() {
        ...
        if (chance == 1) {
            ...
            Image cometImage = new Image("resources/comet.png");
