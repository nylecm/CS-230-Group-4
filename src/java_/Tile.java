...
public abstract class Tile {
    private static final String FLOOR_TILE_NOT_OF_ALLOWED_TYPE_MSG =
            "java.Tile must have an appropriate typeName, for it's type.";
    protected final TileType type;

    /**
     * Requirement to instantiate a new tile that is a subclass of java.Tile. Checks
     * to ensure that the given tile is of a valid type for its classes' allowed
     * types.
     *
     * @param type         the java.TileType of the new instance.
     * @param typesAllowed a set of allowed java.TileType enums, for that subclass.
     */
     ...
     *
     * @return java.TileType type of tile.
     */
    ...
    public String toString() {
        return "java.game.tile.java.Tile{" +
