...
/**
 * Represents a floor tile that makes up the game board.
 ...
 * position. The paths attribute is represented by a bitmask.
 *
...
public class FloorTile extends Tile {
     ...
     *
     * @param type the java.TileType of the new floor tile (eg CORNER).
     */
